    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-md-6 col-lg-6 col-xl-4 offset-xl-1">
        <form>
          ...
          <div class="form-outline mb-3">
            <div class="input-group">
              ...
              <div class="form-outline">
                <input type="text" id="aform-docu-nmro" class="form-control form-control-lg" />
                <label class="form-label" for="aform-docu-nmro">Password</label>
              </div>
          ...
          <div class="input-group mb-3">
            <span class="input-group-text"><i class="fa fa-lock"></i></span>
            <input class="form-control form-control-lg" id="username" name="username" placeholder="Username" value="">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text"><i class="fa fa-lock"></i></span>
            <input class="form-control form-control-lg" id="password" name="password" placeholder="Password" value="">
